...
const PRIMARY =
  colors.primary || '#0D2B7E';

const SECONDARY =
  colors.secondary || '#1A4FB5';
...
const MASSAGE_TYPES = [
...

  {
    ...
    duration: '60–90 min',
    minPrice: 35000,
    description: 'Soulage les tensions',
  },
...

  {
    ...
    duration: '30–60 min',
    minPrice: 30000,
    description: 'Bien-être des pieds',
  },

  {
    id: 6,
    name: 'Pierres Chaudes',
    shortName: 'Pierres chaudes',
    icon: 'fire',
    duration: '60–90 min',
    minPrice: 55000,
    description: 'Chaleur & relaxation',
  },
];
...
const PROMOTIONS = [
  {
    ...
    description:
      'Profitez d’une séance bien-être à prix réduit.',
    discount: 20,
    endDate: '31 août',
    icon: 'spa',
  },

  {
    ...
    description:
      'Préparez votre corps ou récupérez après l’effort.',
    discount: 15,
    endDate: '15 sept.',
    icon: 'run',
  },

  {
    ...
    description:
      'Une expérience chaleureuse pour une détente totale.',
    discount: 10,
    endDate: '30 sept.',
    icon: 'fire',
  },
...
const Toast = ({
  ...
  const scale =
    useRef(new Animated.Value(0.92)).current;
...
const HomeScreen = ({ navigation }) => {
  ...
  const background =
    ...
    (isDark ? '#101217' : '#F7F9FC');

  const text =
    themeColors.text ||
    (isDark ? '#FFFFFF' : '#151923');
      ...
      ({ item }) => (
        ...
        >
          ...
          <LinearGradient
            ...
            style={
              styles.promotionGradient
            }
          >

            <View
              style={
                styles.promotionCircleOne
              }
            />

            <View
              style={
                styles.promotionCircleTwo
              }
            />
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Laissez notre intelligence
                  artificielle trouver le massage
                  et le thérapeute qui vous correspondent.
                </Text>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  disponibles autour de vous grâce
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Utilisez le bouton SOS en cas
                de situation urgente.
              </Text>
